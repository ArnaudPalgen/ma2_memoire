...
\tikzstyle{rectA} = [rectangle, minimum width=0.5cm, minimum height=1cm,text centered, draw=black, fill=red]
\tikzstyle{rectB} = [rectangle, minimum width=0.5cm, minimum height=1cm,text centered, draw=black, fill=blue]
\tikzstyle{rectC} = [rectangle, minimum width=0.5cm, minimum height=1cm,text centered, draw=black, fill=grey]